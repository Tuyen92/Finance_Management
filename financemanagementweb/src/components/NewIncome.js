                ...
                <FormGroup  style={{ width: '100%' }}>
                    <form onSubmit={create}>
                        <div style={{ display: 'flex' }}>
                            ...
                            <Input id="content" type="text" style={{ width: '70%', marginRight: '2%' }} name="content" value={income.content} onChange={setValue} />

                            <h4 style={{ color: "#F1C338", marginRight: '2%' }}>Income: </h4>
                            <Input id="id" type="text" style={{ width: '10%', marginRight: '2%' }} name="income_amount" value={income.income_amount} onChange={setValue} />
                        </div>

                        <h4 style={{ color: "#F1C338", marginRight: '2%' }}>Describe: </h4>
                        <Input id="id" type="text" multiline fullWidth rows={4} style={{ width: '100%' }} name="describe" value={income.describe} onChange={setValue} />

                        <div style={{ display: 'flex' }}>
                            <h4 style={{ color: "#F1C338", marginRight: '2%' }}>Group: </h4>
                            <Input id="id" type="text" style={{ width: '5%', marginRight: '2%' }} name="group" value={income.group} onChange={setValue} />
                        
                            <h4 style={{ color: "#F1C338", marginRight: '2%' }}>Project: </h4>
                            <Input id="content" type="text" style={{ width: '5%', marginRight: '2%' }} name="project" value={income.project} onChange={setValue} />
                        </div>
                        <br />
                        <div align='center'>
